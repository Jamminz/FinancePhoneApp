...
namespace PhoneApp1
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void button1_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bool userValid =
                    context.Users.Any(o => o.Username == userField.Text && o.Password == passwordBox.Password);

                if (userValid)
                {
                    var obj = App.Current as App;
                    GlobalClass.whoIsLoggedIn = userField.Text;
                    NavigationService.Navigate(new Uri("/Views/Dashboard.xaml", UriKind.Relative));
                }
                else
                {
                    MessageBox.Show("Username or password not not found");
                }
            }
